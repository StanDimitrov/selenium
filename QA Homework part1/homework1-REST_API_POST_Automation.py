...
enter_additional_data = driver.find_element(By.CSS_SELECTOR, '#operations-pet-uploadFile > div.no-margin > div > div.opblock-section > div.parameters-container > div > table > tbody > tr:nth-child(2) > td.parameters-col_description > input[type=text]').send_keys('{"bread" : "chihuahua", "name" : "Sparky", "age": "1"}' + Keys.ENTER)
